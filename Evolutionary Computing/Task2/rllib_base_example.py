...
from cartpole_example.cartpole_env import CartPoleLeftRight
from rllib_examples.rllib_callback import CustomCallbacks
...
tune.run(
    ...
    storage_path="E:\Projects\\rl_frameworks_bench\\rllib_examples\\results"
)
